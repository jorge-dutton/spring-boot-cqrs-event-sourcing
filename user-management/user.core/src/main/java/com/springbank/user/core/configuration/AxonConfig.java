...
/**
 * Axon MongoDB configuration. Mostly boilerplate code to get this running
 * @author jorge.dutton
 *
 */
...
public class AxonConfig {
	...
	public MongoClient mongo() {
		...
		mongoSettingsFactory
				.setMongoAddresses(Collections.singletonList(new ServerAddress(this.mongoHost, this.mongoPort)));
	...
	public MongoTemplate axonMongoTemplate() {
		return DefaultMongoTemplate.builder().mongoDatabase(this.mongo(), this.mongoDatabase).build();
	}

	@Bean
	public TokenStore tokenStore(Serializer serializer) {
		return MongoTokenStore.builder().mongoTemplate(this.axonMongoTemplate()).serializer(serializer).build();
	}
